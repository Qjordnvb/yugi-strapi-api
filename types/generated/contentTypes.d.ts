...
export interface ApiPlatformPlatform extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    supported: Attribute.Boolean & Attribute.DefaultTo<true>;
...
export interface ApiYugiohcardYugiohcard extends Schema.CollectionType {
  collectionName: 'yugiohcards';
  info: {
    singularName: 'yugiohcard';
    pluralName: 'yugiohcards';
    displayName: 'Yugiohcard';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    name: Attribute.String;
    image_url_small: Attribute.Media;
    type: Attribute.String;
    desc: Attribute.Text;
    archetype: Attribute.String;
    url: Attribute.UID<'api::yugiohcard.yugiohcard', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::yugiohcard.yugiohcard',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::yugiohcard.yugiohcard': ApiYugiohcardYugiohcard;
    }
  }
}
